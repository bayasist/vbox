  ...
  { "The table of content XML document does not have a toc element.",
    ...
    "VERR_XML_TOC_ELEMENT_MISSING",
     VERR_XML_TOC_ELEMENT_MISSING }, 
  { "The table of content XML element (toc) has sibilings, we expected it to be an only child or the root element (xar).",
    "The table of content XML element (toc) has sibilings, we expected it to be an only child or the root element (xar).",
  ...
  { "Image Verficiation Failure: Error allocating memory for state data.",
    ...
    "VERR_LDRVI_NO_MEMORY_STATE",
     VERR_LDRVI_NO_MEMORY_STATE }, 
  { "Image Verficiation Failure: Error allocating memory for authenticode signature data.",
    "Image Verficiation Failure: Error allocating memory for authenticode signature data.",
  ...
  { "Certificate signature algorithm mismatch.",
    ...
    "VERR_CR_X509_CERT_SIGN_ALGO_MISMATCH",
     VERR_CR_X509_CERT_SIGN_ALGO_MISMATCH }, 
  { "The signature algorithm in the to-be-signed certifcate part does not match the one assoicated with the signature.",
    "The signature algorithm in the to-be-signed certifcate part does not match the one assoicated with the signature.",
  ...
  { "Certificate path validator: Intermediate certificate is not marked as a certificate authority (CA).",
    ...
    "VERR_CR_X509_CPV_NOT_CA_CERT",
     VERR_CR_X509_CPV_NOT_CA_CERT }, 
  { "Certificate path validator: Intermeidate certificate is not a version 3 certificate.",
    "Certificate path validator: Intermeidate certificate is not a version 3 certificate.",
  ...
  { "Certificate path validator: Intermediate certificate subject does not match child issuer property.",
    ...
    "VERR_CR_X509_CPV_ISSUER_MISMATCH",
     VERR_CR_X509_CPV_ISSUER_MISMATCH }, 
  { "Certificate path validator: The certificate is not valid at the specificed time.",
    "Certificate path validator: The certificate is not valid at the specificed time.",
  ...
  { "Reason for leaving RC: Unhandled GDT write.",
    "Reason for leaving RC: Unhandled GDT write. Recompiler gets control.",
    "VINF_EM_RAW_EMULATE_INSTR_GDT_FAULT",
     VINF_EM_RAW_EMULATE_INSTR_GDT_FAULT }, 
  { "Reason for leaving RC: Unhandled Page Directory write.",
    "Reason for leaving RC: Unhandled Page Directory write. Recompiler gets control.",
  ...
  { "Reason for leaving RC: Hlt instruction.",
    "Reason for leaving RC: Hlt instruction. Recompiler gets control.",
  ...
  { "Incompatible CPUM configuration.",
    ...
    "VERR_CPUM_INCOMPATIBLE_CONFIG",
     VERR_CPUM_INCOMPATIBLE_CONFIG }, 
  { "CPUMR3DisasmInstrCPU unexpectedly failed to determin the hidden parts of the CS register.",
    "CPUMR3DisasmInstrCPU unexpectedly failed to determin the hidden parts of the CS register.",
  ...
  { "VT-x features for SMX operation disabled by the BIOS.",
    "VT-x features for SMX operation disabled by the BIOS.",
    "VERR_VMX_MSR_SMX_VMXON_DISABLED",
     VERR_VMX_MSR_SMX_VMXON_DISABLED }, 
  ...
  { "Syntax error - buggy parser.",
    ...
    "VERR_DBGC_PARSE_BUG",
     VERR_DBGC_PARSE_BUG }, 
  { "Process Verficiation Failure: The memory content does not match the image file.",
    "Process Verficiation Failure: The memory content does not match the image file.",
    "VERR_SUP_VP_MEMORY_VS_FILE_MISMATCH",
     VERR_SUP_VP_MEMORY_VS_FILE_MISMATCH }, 
  { "Process Verficiation Failure: The memory protection of a image file section does not match what the section header prescribes.",
    "Process Verficiation Failure: The memory protection of a image file section does not match what the section header prescribes.",
    "VERR_SUP_VP_SECTION_PROTECTION_MISMATCH",
     VERR_SUP_VP_SECTION_PROTECTION_MISMATCH }, 
  { "Process Verficiation Failure: One of the section in the image file is not mapped into memory.",
    "Process Verficiation Failure: One of the section in the image file is not mapped into memory.",
    "VERR_SUP_VP_SECTION_NOT_MAPPED",
     VERR_SUP_VP_SECTION_NOT_MAPPED }, 
  { "Process Verficiation Failure: One of the section in the image file is not fully mapped into memory.",
    "Process Verficiation Failure: One of the section in the image file is not fully mapped into memory.",
  ...
  { "Process Verficiation Failure: Bad optional header field.",
    ...
    "VERR_SUP_VP_BAD_OPTIONAL_HEADER",
     VERR_SUP_VP_BAD_OPTIONAL_HEADER }, 
  { "Process Verficiation Failure: Bad section alignment value in image header.",
    "Process Verficiation Failure: Bad section alignment value in image header.",
  ...
  { "Process Verficiation Failure: Image section region is too large.",
    ...
    "VERR_SUP_VP_EMPTY_REGION_TOO_LARGE",
     VERR_SUP_VP_EMPTY_REGION_TOO_LARGE }, 
  { "Process Verficiation Failure: Exectuable file name and process image name does not match up.",
    "Process Verficiation Failure: Exectuable file name and process image name does not match up.",
    "VERR_SUP_VP_EXE_VS_PROC_NAME_MISMATCH",
     VERR_SUP_VP_EXE_VS_PROC_NAME_MISMATCH }, 
  { "Process Verficiation Failure: Found executable memory allocated in the process.",
    "Process Verficiation Failure: Found executable memory allocated in the process. There is only supposed be executable memory associated with image file mappings (DLLs & EXE).",
    "VERR_SUP_VP_FOUND_EXEC_MEMORY",
     VERR_SUP_VP_FOUND_EXEC_MEMORY }, 
  { "Process Verficiation Failure: There is more than one known executable mapped into the process.",
    "Process Verficiation Failure: There is more than one known executable mapped into the process.",
  ...
  { "Process Verficiation Failure: Error reading image file header.",
    ...
    "VERR_SUP_VP_IMAGE_HDR_READ_ERROR",
     VERR_SUP_VP_IMAGE_HDR_READ_ERROR }, 
  { "Process Verficiation Failure: Image mapping is bogus as the first region has different AllocationBase and BaseAddress values, indicating that a section was unmapped or otherwise tampered with.",
    "Process Verficiation Failure: Image mapping is bogus as the first region has different AllocationBase and BaseAddress values, indicating that a section was unmapped or otherwise tampered with.",
    "VERR_SUP_VP_IMAGE_MAPPING_BASE_ERROR",
     VERR_SUP_VP_IMAGE_MAPPING_BASE_ERROR }, 
  { "Process Verficiation Failure: Error reading process memory for comparing with disk data.",
    "Process Verficiation Failure: Error reading process memory for comparing with disk data.",
    "VERR_SUP_VP_MEMORY_READ_ERROR",
     VERR_SUP_VP_MEMORY_READ_ERROR }, 
  { "Process Verficiation Failure: Found no executable mapped into the process address space.",
    "Process Verficiation Failure: Found no executable mapped into the process address space.",
  ...
  { "Process Verficiation Failure: An image mapping failed to report a name.",
    ...
    "VERR_SUP_VP_NO_IMAGE_MAPPING_NAME",
     VERR_SUP_VP_NO_IMAGE_MAPPING_NAME }, 
  { "Process Verficiation Failure: No KERNE32.",
    "Process Verficiation Failure: No KERNE32.DLL mapping found. This is impossible.",
  ...
  { "Process Verficiation Failure: Error allocating memory.",
    ...
    "VERR_SUP_VP_NO_MEMORY",
     VERR_SUP_VP_NO_MEMORY }, 
  { "Process Verficiation Failure: Erorr allocating state memory or querying the system32 path.",
    "Process Verficiation Failure: Erorr allocating state memory or querying the system32 path.",
    "VERR_SUP_VP_NO_MEMORY_STATE",
     VERR_SUP_VP_NO_MEMORY_STATE }, 
  { "Process Verficiation Failure: No NTDLL.",
    "Process Verficiation Failure: No NTDLL.DLL mapping found. This is impossible.",
    "VERR_SUP_VP_NO_NTDLL_MAPPING",
     VERR_SUP_VP_NO_NTDLL_MAPPING }, 
  { "Process Verficiation Failure: A DLL residing outside System32 was found in the process.",
    "Process Verficiation Failure: A DLL residing outside System32 was found in the process.",
    "VERR_SUP_VP_NON_SYSTEM32_DLL",
     VERR_SUP_VP_NON_SYSTEM32_DLL }, 
  { "Process Verficiation Failure: An unknown and unwanted DLL was found loaded into the process.",
    "Process Verficiation Failure: An unknown and unwanted DLL was found loaded into the process.",
    "VERR_SUP_VP_NOT_KNOWN_DLL_OR_EXE",
     VERR_SUP_VP_NOT_KNOWN_DLL_OR_EXE }, 
  { "Process Verficiation Failure: The name of an image file changes between mapping regions.",
    "Process Verficiation Failure: The name of an image file changes between mapping regions.",
  ...
  { "Process Verficiation Failure: Error query virtual memory mapping name.",
    ...
    "VERR_SUP_VP_NT_QI_VIRTUAL_MEMORY_NM_ERROR",
     VERR_SUP_VP_NT_QI_VIRTUAL_MEMORY_NM_ERROR }, 
  { "Process Verficiation Failure: Error determining the full path of System32.",
    "Process Verficiation Failure: Error determining the full path of System32.",
  ...
  { "Process Verficiation Failure: An image has too many regions.",
    ...
    "VERR_SUP_VP_TOO_MANY_IMAGE_REGIONS",
     VERR_SUP_VP_TOO_MANY_IMAGE_REGIONS }, 
  { "Process Verficiation Failure: The process has too many virtual memory regions.",
    "Process Verficiation Failure: The process has too many virtual memory regions.",
  ...
  { "Process Verficiation Failure: An image has too many sections.",
    ...
    "VERR_SUP_VP_TOO_MANY_SECTIONS",
     VERR_SUP_VP_TOO_MANY_SECTIONS }, 
  { "Process Verficiation Failure: An image is targetting an unexpected machine/CPU.",
    "Process Verficiation Failure: An image is targetting an unexpected machine/CPU.",
    "VERR_SUP_VP_UNEXPECTED_IMAGE_MACHINE",
     VERR_SUP_VP_UNEXPECTED_IMAGE_MACHINE }, 
  { "Process Verficiation Failure: Unexpected section protection flag combination.",
    "Process Verficiation Failure: Unexpected section protection flag combination.",
    "VERR_SUP_VP_UNEXPECTED_SECTION_FLAGS",
     VERR_SUP_VP_UNEXPECTED_SECTION_FLAGS }, 
  { "Process Verficiation Failure: Expected the process and exe to have forced integrity checking enabled (verifying signatures).",
    "Process Verficiation Failure: Expected the process and exe to have forced integrity checking enabled (verifying signatures).",
    "VERR_SUP_VP_EXE_MISSING_FORCE_INTEGRITY",
     VERR_SUP_VP_EXE_MISSING_FORCE_INTEGRITY }, 
  { "Process Verficiation Failure: Expected the process and exe to have dynamic base enabled.",
    "Process Verficiation Failure: Expected the process and exe to have dynamic base enabled.",
    "VERR_SUP_VP_EXE_MISSING_DYNAMIC_BASE",
     VERR_SUP_VP_EXE_MISSING_DYNAMIC_BASE }, 
  { "Process Verficiation Failure: Expected the process and exe to advertise NX compatibility.",
    "Process Verficiation Failure: Expected the process and exe to advertise NX compatibility.",
    "VERR_SUP_VP_EXE_MISSING_NX_COMPAT",
     VERR_SUP_VP_EXE_MISSING_NX_COMPAT }, 
  { "Process Verficiation Failure: The DllCharacteristics of the process does not match the value in the optional header in the exe file.",
    "Process Verficiation Failure: The DllCharacteristics of the process does not match the value in the optional header in the exe file.",
    "VERR_SUP_VP_DLL_CHARECTERISTICS_MISMATCH",
     VERR_SUP_VP_DLL_CHARECTERISTICS_MISMATCH }, 
  { "Process Verficiation Failure: The ImageCharacteristics of the process does not match the value in the file header in the exe file.",
    "Process Verficiation Failure: The ImageCharacteristics of the process does not match the value in the file header in the exe file.",
  ...
  { "The image is required to force integrity checks.",
    ...
    "VERR_SUP_VP_SIGNATURE_CHECKS_NOT_ENFORCED",
     VERR_SUP_VP_SIGNATURE_CHECKS_NOT_ENFORCED }, 
  { "Process Verficiation Failure: Symantec Endpoint Protection must be disabled for the VirtualBox VM processes.",
    "Process Verficiation Failure: Symantec Endpoint Protection must be disabled for the VirtualBox VM processes. http://www.symantec.com/connect/articles/creating-application-control-exclusions-symantec-endpoint-protection-121.",
  ...
  { "Process Purification Failure: NtFreeVirtualMemory failed on a chunk of executable memory which shouldn't be present in the process.",
    ...
    "VERR_SUP_VP_FREE_VIRTUAL_MEMORY_FAILED",
     VERR_SUP_VP_FREE_VIRTUAL_MEMORY_FAILED }, 
  { "Process Purification Failure: Both NtUnmapViewOfSetion and NtProtectVirtualMemory failed to get rid of or passify an non-image exectuable mapping.",
    "Process Purification Failure: Both NtUnmapViewOfSetion and NtProtectVirtualMemory failed to get rid of or passify an non-image exectuable mapping.",
  ...
  { "Stub process not found so it cannot be revalidated when vboxdrv is opened by the VM process.",
    ...
    "VERR_SUP_VP_STUB_NOT_FOUND",
     VERR_SUP_VP_STUB_NOT_FOUND }, 
  { "Error openeing the stub process for revalidation when vboxdrv is opened by the VM process.",
    "Error openeing the stub process for revalidation when vboxdrv is opened by the VM process.",
