...
inline uint32_t X86_CPUID_AMD_FEATURE_ECX_SSE5 = 1U << 11;
...
inline uint32_t X86_CR4_OSFSXR = 1U << 9;
 ...
 * @{ */
/** Exception Flag: Invalid operation.  */
inline uint32_t X86_MSXCR_IE = 1U << 0;

/** Exception Flag: Denormalized operand.  */
inline uint32_t X86_MSXCR_DE = 1U << 1;

/** Exception Flag: Zero divide.  */
inline uint32_t X86_MSXCR_ZE = 1U << 2;

/** Exception Flag: Overflow.  */
inline uint32_t X86_MSXCR_OE = 1U << 3;

/** Exception Flag: Underflow.  */
inline uint32_t X86_MSXCR_UE = 1U << 4;

/** Exception Flag: Precision.  */
inline uint32_t X86_MSXCR_PE = 1U << 5;


/** Denormals are zero. */
inline uint32_t X86_MSXCR_DAZ = 1U << 6;


/** Exception Mask: Invalid operation. */
inline uint32_t X86_MSXCR_IM = 1U << 7;

/** Exception Mask: Denormalized operand. */
inline uint32_t X86_MSXCR_DM = 1U << 8;

/** Exception Mask: Zero divide.  */
inline uint32_t X86_MSXCR_ZM = 1U << 9;

/** Exception Mask: Overflow.  */
inline uint32_t X86_MSXCR_OM = 1U << 10;

/** Exception Mask: Underflow.  */
inline uint32_t X86_MSXCR_UM = 1U << 11;

/** Exception Mask: Precision.  */
inline uint32_t X86_MSXCR_PM = 1U << 12;


/** Rounding control mask. */
inline uint16_t X86_MSXCR_RC_MASK = 0x6000;

/** Rounding control: To nearest. */
inline uint16_t X86_MSXCR_RC_NEAREST = 0x0000;

/** Rounding control: Down. */
inline uint16_t X86_MSXCR_RC_DOWN = 0x2000;

/** Rounding control: Up. */
inline uint16_t X86_MSXCR_RC_UP = 0x4000;

/** Rounding control: Towards zero. */
inline uint16_t X86_MSXCR_RC_ZERO = 0x6000;


/** Flush-to-zero for masked underflow.  */
inline uint32_t X86_MSXCR_FZ = 1U << 15;


/** Misaligned Exception Mask.  */
inline uint32_t X86_MSXCR_MM = 1U << 16;
...
inline uint8_t X86_OP_PRF_REPZ = 0xf2;

inline uint8_t X86_OP_PRF_REPNZ = 0xf3;
